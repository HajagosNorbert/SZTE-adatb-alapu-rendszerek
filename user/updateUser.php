...
$utils->updateUser($_POST["userId"], $_POST["vezeteknev"], $_POST["keresztnev"], $_POST["jelszo"], $admin, $_POST["userType"], $szemeszter, $tanitas_kezdete);


header("location: ./userForm.php?id=".$_POST["userId"]);
